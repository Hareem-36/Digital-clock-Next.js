    ...
    <div className="flex items-center justify-center h-screen">
      ...
      <Card className="p-8 shadow-lg rounded-2xl">
        <div className="flex flex-col items-center justify-center">
          {/* Header with title */}
          <div className="text-3xl font-bold tracking-tight">Digital Clock</div>
          {/* Description */}
        ...
        </div><br></br> <center><h1 style={{ color: "darkblue", fontStyle: "bold", fontSize:25 }}>Develop by : Hareem Jaweid</h1></center>
      </Card>
    </div>
